                ...
                files.map((c) => {
                  return (
                    <tr className=" my-4 py-1 ">
                      ...
                      <td>
                        <button
                          onClick={() => getdata("docs", c.clientid)}
                      ...
                      <td>
                        <button
                          onClick={() => getdata("quotation", c.clientid)}
                          className=" w-max bg-blue-600 px-10 py-1 text-white  rounded-md"
                        >
                          View
                        </button>
                      ...
                      <td>
                        ...
                        <div className=" flex justify-center items-center   mr-2">
                          {" "}
                          <p
                            className={`${c.approval}  text-yellow-50 p-0 rounded-md py-1 px-1 font-medium`}
                          >
                            {" "}
                            {c.approval}
                          </p>
                      ...
                      <td className=" ">
                        {c.approval !== "Pending" ? (
                          <div className=" flex justify-center">
                            {c.approval === "Approved" ? (
                              <button className=" text-green-500 ico">
                                <DeleteIcon />
                              </button>
                            ) : (
                              <button className=" text-red-500 ico">
                                <DeleteIcon />
                              </button>
                            )}
                          </div>
                          ...
                          <div className="  text-green-400 ">
                            <div className="flex justify-center items-center ">
                              <div
                                onClick={() =>
                                  accept(c.requirementfile, c.clientid)
                                }
                                className=""
                              >
                                <CheckBoxIcon
