...
const Docs = ({ Qo, handleCloseQo, handleOpenQo }) => {
  ...
  const store = () => {
    storeclient(apps, SrDev, JrDev, UiUx, projectname, projectoverview);
  };
  const closeQo = () => {
    store();
    uploadDoc(base64Doc);
    uploadQuotation(base64Qo);
        ...
        <div className="prepare flex justify-center items-center h-full flex-col">
          {!loading && !data && !docs && (
            <div className=" flex flex-col text-center items-center">
              <p>
                Generate your documentation using chat-gpt by clicking on
                prepare now
              </p>
              <button
                disabled={loading}
          ...
          {loading && (
            <div className="generate mt-4 flex justify-center items-center flex-col">
              <p>Generating documentation using Chat-Gpt....</p>
